...
namespace ApplicationCore.Cam
{
    public class Cam1KeepTableController
    {
        ...
        public Cam1KeepTableController(IDataAccess _iDataAccessGeneralTables)
        {
        ...
        public void Run(string timeBeforeDeviationTextBox, string timeAfterDeviationTextBox)
        {
            ...
            {
                Debug.WriteLine($"Exception in Cam1KeepTableController : Run: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in Cam1KeepTableController : Run: ex.StackTrace = " + ex.StackTrace);
            }
        }
        ...
        public void MoveThesePictureFilesToKeepFolder(List<PictureSampleModel> deviationPictureSamples)
        {
            ...
            {
                Debug.WriteLine($"Exception in Cam1KeepTableController : MoveThesePictureFilesToKeepFolder: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in Cam1KeepTableController : MoveThesePictureFilesToKeepFolder: ex.StackTrace = " + ex.StackTrace);
            }
        }
        public void MoveThesePostsToKeep(List<PictureSampleModel> deviationPictureSamples)
        {
            ...
            {
                Debug.WriteLine($"Exception in Cam1KeepTableController : MoveThesePostsToKeep: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in Cam1KeepTableController : MoveThesePostsToKeep: ex.StackTrace = " + ex.StackTrace);
            }
        }
        ...
        public List<PictureSampleModel> lookForDeviationDataInTable(string tableName, Int64 _latestDeviationTime_unixTime, string TimeBeforeDeviationTextBox, string TimeAfterDeviationTextBox)
        {
            ...
            {
                Debug.WriteLine($"Exception in Cam1KeepTableController : lookForDeviationDataInTable: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in Cam1KeepTableController : lookForDeviationDataInTable: ex.StackTrace = " + ex.StackTrace);
            }
        ...
        public Int64 getUnixTimeOfLatestDeviation()
        {
            ...
            {
                Debug.WriteLine($"Exception in Cam1KeepTableController : getUnixTimeOfLatestDeviation: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in Cam1KeepTableController : getUnixTimeOfLatestDeviation: ex.StackTrace = " + ex.StackTrace);
            }
