...
{
    public class Cam2OddTableController
    {
        private IDataAccess iDataAccess;
        private List<PictureSampleModel> pictureSamples;

        public Cam2OddTableController(IDataAccess _iDataAccess)
        {
        ...
        public void Run()
        {
            ...
            {
                Debug.WriteLine($"Exception in Cam2OddTableController : Run: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in Cam2OddTableController : Run: ex.StackTrace = " + ex.StackTrace);
            }
        }
    }
}
