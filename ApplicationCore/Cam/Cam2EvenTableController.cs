...
namespace ApplicationCore.Cam
{
    public class Cam2EvenTableController
    {
        ...
        public void Run()
        {
            ...
            {
                Debug.WriteLine($"Exception in Cam2EvenTableController : Run: ex.Message = " + ex.Message);
                Debug.WriteLine($"Exception in Cam2EvenTableController : Run: ex.StackTrace = " + ex.StackTrace);
            }
        }
    }
}